...
class ValidationExecutor {
    ...
    nestedValidations(value, metadatas, errors) {
        ...
        metadatas.forEach(metadata => {
            ...
            if (value instanceof Array || value instanceof Set || value instanceof Map) {
                ...
                const [type, message, detail] = this.createValidationError(metadata.target, value, metadata);
                error.constraints = {
                    [type]: message,
                };
                errors.push(error);
    ...
    createValidationError(object, value, metadata, customValidatorMetadata) {
        ...
        const detail = ValidationUtils_1.ValidationUtils.replaceMessageSpecialTokens(message, validationArguments);
